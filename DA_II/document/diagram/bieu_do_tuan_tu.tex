\section{Biểu đồ tuần tự}
  ...
  \subsection*{Thống kê}
    \begin{center}
      \includegraphics[width=.65\textwidth]{../out/drawio/sequence/statistical/statistical.png}
      \begin{figure}[h]
        \centering
  ...
  \subsection*{Đăng ký thực tập}
    \begin{center}
      \includegraphics[width=.85\textwidth]{../out/drawio/sequence/registerthuctap/rt.png}
      \begin{figure}[h]
        \centering
  ...
  \subsection*{Tra cứu thông tin}
    \begin{center}
      \includegraphics[width=.85\textwidth]{../out/drawio/sequence/searchinfo/si.png}
      \begin{figure}[h]
        \centering
